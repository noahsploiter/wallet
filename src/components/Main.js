...
function Main() {
  ...
  return (
    <section>
      ...
      <div className="space-y-5 md:space-y-0 justify-center flex flex-row  text-white md:flex flex-wrap md:space-x-5 w-screen">
        ...
        <div className="p-5 border w-[350px] rounded-xl space-y-2">
          ...
          <h2>Cvv: 271</h2>
          <div>
            <button className="rounded-xl active:bg-violet-700">
              Purchase
            </button>
          </div>
        </div>
